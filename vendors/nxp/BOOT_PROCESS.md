...
- [NXP i.MX Boot Process and Bootable Image Generation](#nxp-imx-boot-process-and-bootable-image-generation)
  ...
  - [2. Boot Stages](#2-boot-stages)
    ...
    - [2.3 Stage 3: ARM Trusted Firmware (ATF) \[i.MX 8/9 only\]](#23-stage-3-arm-trusted-firmware-atf-imx-89-only)
  ...
  - [4. Image Generation Process](#4-image-generation-process)
    ...
    - [4.2 Step-by-Step Process](#42-step-by-step-process)
      - [4.2.1 Step 1: Build Firmware Components](#421-step-1-build-firmware-components)
      - [4.2.2 Step 2: Obtain NXP Firmware Blobs](#422-step-2-obtain-nxp-firmware-blobs)
      - [4.2.3 Step 3: Use imx-mkimage Tool](#423-step-3-use-imx-mkimage-tool)
      - [4.2.4 Step 4: Flash to Boot Media](#424-step-4-flash-to-boot-media)
  - [5. Boot Media Layout](#5-boot-media-layout)
    - [5.1 SD/eMMC Layout](#51-sdemmc-layout)
    - [5.2 Detailed Boot Region Layout (i.MX 8M Plus example)](#52-detailed-boot-region-layout-imx-8m-plus-example)
  - [6. Processor-Specific Variations](#6-processor-specific-variations)
    - [6.1 i.MX 6 Series (i.MX 6Q, 6DL, 6S, 6SX, 6UL, etc.)](#61-imx-6-series-imx-6q-6dl-6s-6sx-6ul-etc)
    - [6.2 i.MX 7 Series (i.MX 7D, 7S, 7ULP)](#62-imx-7-series-imx-7d-7s-7ulp)
    - [6.3 i.MX 8 QuadMax / QuadXPlus (QM/QXP)](#63-imx-8-quadmax--quadxplus-qmqxp)
    - [6.4 i.MX 8M Family (8MQ, 8MM, 8MN, 8MP)](#64-imx-8m-family-8mq-8mm-8mn-8mp)
    - [6.5 i.MX 8ULP (Ultra Low Power)](#65-imx-8ulp-ultra-low-power)
    - [6.6 i.MX 9 Series (i.MX 93)](#66-imx-9-series-imx-93)
  ...
  - [8. Troubleshooting](#8-troubleshooting)
    - [8.1 Common Boot Issues](#81-common-boot-issues)
      - [8.1.1 Issue 1: Board Doesn't Boot (No Output)](#811-issue-1-board-doesnt-boot-no-output)
      - [8.1.2 Issue 2: SPL Loads but U-Boot Fails](#812-issue-2-spl-loads-but-u-boot-fails)
      - [8.1.3 Issue 3: U-Boot Starts but Kernel Fails to Load](#813-issue-3-u-boot-starts-but-kernel-fails-to-load)
      - [8.1.4 Issue 4: Secure Boot / HAB Failures](#814-issue-4-secure-boot--hab-failures)
